...
* Поддержка браузеров: последние две версии Chrome, Firefox, Safarі, Opera, MS Edge.
* Корректное отображение на iPhone6S, Galaxy Note4 (https://www.browserstack.com). 
* Допускается использование bootsrap(только сетка) и библиотеки JQuery.  
...
* При наведении курсора мыши на изображение над ним появляется желтый полупрозрачный слой с информацией о категории изображения. 
...
* Добавьте произвольное фото для 4-x членов команды.
...
* Для решения задачи используйте регулярные выражения и JavaScript (интсурменты: https://regex101.com/)
